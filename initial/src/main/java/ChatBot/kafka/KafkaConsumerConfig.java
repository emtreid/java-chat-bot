...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, AccountResponse> accountResponseConsumerFactory() {
        JsonDeserializer<AccountResponse> deserialiser = new JsonDeserializer<AccountResponse>(AccountResponse.class);
        deserialiser.addTrustedPackages("*");
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapAddress);
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "*");
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "accountResponse");
        return new DefaultKafkaConsumerFactory<>(props, new StringDeserializer(), deserialiser);
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, AccountResponse> accountResponseConcurrentKafkaListenerContainerFactory() {
